package core.seventeen_inner;

import java.util.Scanner;
/*Переробити задачі з Comparator так, щоб використовувалися anonymous classes,
...
//Повинні бути такі методи: ● Додати товар ● Видалити товар ● Замінити товар ● Сортувати за назвоню
//● Сортувати за довжиною ● Сортувати за шириною ● Сортувати за вагою
//● Виводимо і-тий елемент колекції(який ми вводимо з консолі(використовуємо Scanner))
//● Вийти з програми(підказка System.exit). Для меню використати Switch.
public class Main {
    static void menu() {
    ...
    public static void main(String[] args) {
        AnonymousStorage storage = new AnonymousStorage();
